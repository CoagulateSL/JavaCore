...
public class TraceProfiler {
	...
	private static final Map<String,Map<String,Integer>> profiles=new HashMap<>();
			// map of profile name to map of stack trace to count
	...
	public static String reportProfile(final String setname) {
		...
		final Map<String,Integer> profile=
				new HashMap<>(profiles.get(setname)); // avoid concurrent modification exception :P hopefully
