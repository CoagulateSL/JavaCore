...
public abstract class Passwords {
	...
	private static boolean verifyPassword(final char[] password,
	                                      @Nonnull
	                                      final String correctHash) throws CannotPerformOperationException, InvalidHashException {
	...
	public static class CannotPerformOperationException extends Exception {
		...
		public CannotPerformOperationException(final String message,final Throwable cause) {
			super(message,cause);
		}
	}
